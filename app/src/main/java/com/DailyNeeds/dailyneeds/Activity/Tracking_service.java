...
public class Tracking_service extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,PermissionUtils.PermissionResultCallback {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        //old code
      startActivity(new Intent(Tracking_service.this,MainActivity.class));
        //old code
      finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        location_detect();
        permissionUtils = new PermissionUtils(Tracking_service.this);
        ...
        try {
            ...
            if (getIntent().getStringExtra("model")!=null){
                ...
                Log.d("gresponse","gresponse"+gresponse);
                ...
                Log.e("AddressTest", assigned_services.getAddress());
        ...
        Tracking_service.this.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN | WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN);
       ...
       //new code
        ...
        trackChat.setWebViewClient(new WebViewClient(){
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                Log.d("onestep1:","chat_room: "+chatid);
                Log.d("onestep1:","first_name: "+name);
                Log.d("onestep1:","order_id: "+orderid);
                Log.d("onestep1:","vendor_id: "+vendorid);
                Log.d("onestep1:","user_id: "+userid);
                Log.d("onestep1:","user_type: "+usertype);
                Log.d("onestep1:","service_id: "+service_id);
...
//                        .putExtra("chatid",chatid).putExtra("order_id",orderid).putExtra("vendor_id",vendorid).putExtra("user_id",userid));
                ...
                //latest new code
                Intent intent = new Intent(Tracking_service.this,ChatActivity.class);
        ...
        callIV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Tracking_service.this, CustomDeviceActivity.class).putExtra("mobile",mobile));
            }
        });
        ...
        if (assigned_services.getIs_order_completed().equalsIgnoreCase("Y")){
            ...
            stopService(new Intent(Tracking_service.this, BackgroundLocationUpdateService.class));
        }
        ...
        getApiClient().RejectService(token,orderID,vendorID).enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                if (response.code()==401){
                    ...
                    //new code
                    Log.d("oneoneone11111:","oneoneone11111:"+orderID+" / "+userid);
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            ...
                            status.startResolutionForResult(Tracking_service.this, REQUEST_CHECK_SETTINGS);
            ...
            public void onResponse(Call<CompleteOrderRes> call, Response<CompleteOrderRes> response) {
                ...
                if (response.code()==401){
                    ...
                    if (response.body().getStatus().equalsIgnoreCase("success")) {
                        ...
                        Log.d("oneoneone111111:","oneoneone111111:"+orderID+" / "+userid);

                        stopService(new Intent(Tracking_service.this, BackgroundLocationUpdateService.class));
                        Toast.makeText(Tracking_service.this, "Service Completed Successfully !!!", Toast.LENGTH_SHORT).show();

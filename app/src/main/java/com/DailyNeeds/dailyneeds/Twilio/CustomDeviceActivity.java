package com.DailyNeeds.dailyneeds.Twilio;
...
public class CustomDeviceActivity extends AppCompatActivity {
    ...
    //old url
    private static final String TWILIO_ACCESS_TOKEN_SERVER_URL = "http://3.20.145.140/twilio/accesstoken.php";

//    private static final String TWILIO_ACCESS_TOKEN_SERVER_URL = "https://3.7.111.196/twilio/accesstoken.php";

//    latest url-1 : https://3.7.111.196/twilio/voice_server/accessToken.php
...
*/
    ...
    private RegistrationListener registrationListener() {
        return new RegistrationListener() {
            ...
            public void onError(@NonNull RegistrationException error,
                ...
                Toast.makeText(CustomDeviceActivity.this, message, Toast.LENGTH_SHORT).show();
            }
        };
    }
    ...
    private void setCallUI() {
       /* callActionFab.hide();
        ...
        callActionFab.setVisibility(View.INVISIBLE);
        hangupActionFab.setVisibility(View.VISIBLE);
        holdActionFab.setVisibility(View.VISIBLE);
        muteActionFab.setVisibility(View.VISIBLE);

        inputSwitchFab.setVisibility(View.INVISIBLE);
        chronometer.setVisibility(View.VISIBLE);
        chronometer.setBase(SystemClock.elapsedRealtime());
        chronometer.start();
    ...
    private void resetUI() {
        ...
        callActionFab.setVisibility(View.VISIBLE);
        muteActionFab.setImageDrawable(ContextCompat.getDrawable(CustomDeviceActivity.this, R.drawable.ic_mic_white_24dp));
        holdActionFab.setVisibility(View.INVISIBLE);
        holdActionFab.setBackgroundTintList(ColorStateList
                .valueOf(ContextCompat.getColor(this, R.color.colorAccent)));
        muteActionFab.setVisibility(View.INVISIBLE);
        hangupActionFab.setVisibility(View.INVISIBLE);
        applyFabState(inputSwitchFab, false);
        inputSwitchFab.setVisibility(View.INVISIBLE);
        chronometer.setVisibility(View.INVISIBLE);
        chronometer.stop();
    ...
    private DialogInterface.OnClickListener callClickListener() {
        return (dialog, which) -> {
            ...
            if (contact.getText().toString().length()==10){
                ...
                params.put("to", "+91"+contact.getText().toString());
                ...
                Toast.makeText(CustomDeviceActivity.this, "Enter the valid mobile number!!", Toast.LENGTH_SHORT).show();
                alertDialog.show();
    ...
    private void requestPermissionForMicrophone() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.RECORD_AUDIO)) {
          /*  Snackbar.make(coordinatorLayout,
            ...
            Toast.makeText(CustomDeviceActivity.this," Microphone permissions needed. Please allow in your application settings.", Toast.LENGTH_LONG).show();
        } else {
                ...
                .setCallback((e, accessToken) -> {
                    if (e == null) {
                        ...
                        /*Snackbar.make(coordinatorLayout,
                                ...
                                Snackbar.LENGTH_LONG).show();*/
                        Toast.makeText(CustomDeviceActivity.this, "Error retrieving access token. Unable to make calls", Toast.LENGTH_LONG).show();

package com.DailyNeeds.dailyneeds.LocationUpdate;
...
public class BackgroundLocationUpdateService extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    */
    ...
    private void StartForeground() {
        ...
        builder.setContentTitle("Location Detecting!!!");
        builder.setContentText("Tap here to Stop");
    ...
    public void onLocationChanged(Location location) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("user").child(orderID);
        databaseReference.child("lat_lng").setValue(latitude+","+longitude);
